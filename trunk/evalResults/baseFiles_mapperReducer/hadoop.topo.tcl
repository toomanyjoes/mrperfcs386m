...
# cpu.type = 1.6Ghz cpu.cores = 2 hd.type = drive6
...
# cpu.type = 1.6Ghz cpu.cores = 3 hd.type = drive3
for {set i 0} {$i < 1} {incr i} {
...
# cpu.type = 1.6Ghz cpu.cores = 4 hd.type = drive2
for {set i 0} {$i < 1} {incr i} {
...
# cpu.type = 2.3Ghz cpu.cores = 2 hd.type = drive2
for {set i 0} {$i < 1} {incr i} {
...
# cpu.type = 2.3Ghz cpu.cores = 3 hd.type = drive5
for {set i 0} {$i < 1} {incr i} {
...
# cpu.type = 2.0Ghz cpu.cores = 2 hd.type = drive2
for {set i 0} {$i < 1} {incr i} {
...
# cpu.type = Xeon 3.0Ghz cpu.cores = 2 hd.type = drive3
for {set i 0} {$i < 1} {incr i} {
...
# cpu.type = Xeon 3.0Ghz cpu.cores = 3 hd.type = drive3
for {set i 0} {$i < 1} {incr i} {
...
# cpu.type = Xeon 2.5GHz L5420 cpu.cores = 4 hd.type = drive2
for {set i 0} {$i < 1} {incr i} {
...
# cpu.type = Xeon 3.2Ghz cpu.cores = 1 hd.type = drive6
for {set i 0} {$i < 1} {incr i} {
...
# cpu.type = Xeon 3.2Ghz cpu.cores = 3 hd.type = drive7
for {set i 0} {$i < 1} {incr i} {
...
# cpu.type = Xeon 3.2Ghz cpu.cores = 3 hd.type = drive4
for {set i 0} {$i < 1} {incr i} {
...
# cpu.type = 1.8Ghz cpu.cores = 2 hd.type = drive3
for {set i 0} {$i < 1} {incr i} {
...
# cpu.type = 2.4Ghz cpu.cores = 1 hd.type = drive7
for {set i 0} {$i < 1} {incr i} {
...
# cpu.type = 2.4Ghz cpu.cores = 1 hd.type = drive6
for {set i 0} {$i < 1} {incr i} {
...
for {set i 0} {$i < 1} {incr i} {
	newnode "n_rg0_49_ng0_$i" $routers([expr 8300189012232 % $numRouters]) 11.3208243585Mb 0.232751388421ms
	$n30 set tasklist [new MRPerf/TaskList 2469606195.200000 3]
	for {set j 0} {$j < 2} {incr j} {
		$n30 newdisk 283115520.000000 73400320.000000
	}
