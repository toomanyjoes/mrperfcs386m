# 3320:209
  ...
  if { [info exists n("3320:Wuppertal,Germany")] == 0 } {
  ...
  if { [info exists n("3320:Oldenburg,Germany")] == 0 } {
  ...
  if { [info exists n("3320:Magdeburg,Germany")] == 0 } {
  ...
  if { [info exists n("3320:Darmstadt,Germany")] == 0 } {
  ...
  if { [info exists n("3320:Giessen,Germany")] == 0 } {
    set n("3320:Giessen,Germany") [$ns node] }
  if { [info exists n("3320:Dresden,Germany")] == 0 } {
  ...
  if { [info exists n("3320:Bremen,Germany")] == 0 } {
  ...
  if { [info exists n("3320:Kiel,Germany")] == 0 } {
