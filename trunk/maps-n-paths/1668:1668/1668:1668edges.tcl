# 1668:1668
  if { [info exists n("1668:Charlotte,NC")] == 0 } {
    set n("1668:Charlotte,NC") [$ns node] }
  if { [info exists n("1668:KansasCity,MO")] == 0 } {
  ...
  if { [info exists n("1668:Greensboro,NC")] == 0 } {
